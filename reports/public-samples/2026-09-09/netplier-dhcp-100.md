...
| 标称协议/类型 | DHCP |
| 路径 | `raw/netplier-ndss2021/dhcp_100.pcap` |
| 大小 | 36659 bytes |
| SHA-256 | `29423c20f7066a94971aa2a45dbfea361abf2d88a04edc799ba8a92179d556f1` |
...
| 模块 | 状态 | 结果摘要 |
|---|---|---|
| M01 | `ok` | detected pcap; packets=100, flows=0, streams=0 |
| M02 | `ok` | entropy=2.8983727120479634; printable=0.12234376278676451; zero=0.693608663629668 |
