...
| 标称协议/类型 | SMB2 |
| 路径 | `raw/netplier-ndss2021/smb2_100.pcap` |
| 大小 | 25700 bytes |
| SHA-256 | `594f81e2aa19a75c6842caf0a66be3dcbc61f4894166a37c5d5e66e20b4d7f13` |
...
| 模块 | 状态 | 结果摘要 |
|---|---|---|
| M01 | `ok` | detected pcapng; packets=100, flows=1, streams=1 |
| M02 | `ok` | entropy=3.9155116823372342; printable=0.1351750972762646; zero=0.564591439688716 |
| M07 | `tool_unavailable` | observations=0; protocols=none approved |
| M08 | `no_recoverable_content` | largest TCP direction=8737 bytes; recoveries=0; skipped=0 |
| M09 | `ok` | flows=1; packets=100; unavailable=0 |
