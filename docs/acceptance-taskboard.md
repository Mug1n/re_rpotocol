...
| AC07 clean-directory replay | PASS for saved captures | offline package replay PASS; current host fresh M01/TShark extraction and all 183 tests PASS; live capture still needs Npcap |
